...
export default function Dashboard_Card_Alunos() {
    ...
    useEffect(() => {
        const handlePegarAluno = async () => {
            ...
            setAlunosCadastradas(resp.response);
        };
                    ...
                    {alunosCadastrados.map((aluno, index) => (
                        <div className={css.campo2} key={index}>
                            <div className={css.separa_nome}>
                                ...
                                <button data-id={aluno.id} className={css.btn_lixeira} onClick={(e) => deletarAluno(e)}>
                    ...
                    <Modal isOpen={modalIsOpen} onRequestClose={closeModal} contentLabel="Example Modal" overlayClassName="modal-overlay">
                        <div className="modal-content">
                            ...
                            <div className={css.separa_inps}>
                                ...
                                <button onClick={handleCadastrarUser}>Cadastrar</button>
                            </div>
                        </div>
                    </Modal>
                </div>
